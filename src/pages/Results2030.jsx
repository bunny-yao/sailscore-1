...
function Results2030() {
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-2xl font-bold mb-4">2030年宜蘭中小學帆船運動成績</h2>
        ...
        <table className="min-w-full table-auto">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="border px-4 py-2">黃小龍</td>
              <td className="border px-4 py-2">00:14:20</td>
